...
class ResumeApp:
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/mathanaryha/Smart-Resume-Analyzer' target='_blank' style='text-decoration: none;'>
            ...
            <p style='text-align: center;'>
                ...
                <a href="https://www.linkedin.com/in/mathan-aryha-s-7744-ma" target="_blank" style='text-decoration: none; color: #FFFFFF'>
                    <b>MATHAN ARYHA </b>
                </a>
            </p>
    ...
    <div class="profile-section">
        <img src="https://avatars.githubusercontent.com/u/233711097?s=400&v=4"
             alt="MATHAN ARYHA"
             class="profile-image"
             onerror="this.onerror=null; this.src='https://avatars.githubusercontent.com/u/233711097?s=400&v=4';"
             style="width: 200px; height: 200px; object-fit: cover;">
        <h2 class="profile-name">MATHAN ARYHA</h2>
        <p class="profile-title">Junior Developer </p>
        <div class="social-links">
            <a href="https://github.com/mathanaryha" class="social-link" target="_blank">
                <i class="fab fa-github"></i>
            </a>
            <a href="https://www.linkedin.com/in/mathan-aryha-s-7744-ma" class="social-link" target="_blank">
                <i class="fab fa-linkedin"></i>
            </a>
            <a href="mailto:mathanaryha@gmail.com" class="social-link" target="_blank">
...
<div style="background-color: #1e1e1e; border-radius: 10px; border: 1px solid #4b6cb7; padding: 10px; margin: 10px 0; color: white;">
    ...
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href=" target="_blank" style="color: #4CAF50;"></a></li>
        <li><a href="https://github.com/mathanaryha" target="_blank" style="color: #4CAF50;</a></li>
    </ul>
